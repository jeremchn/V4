...
(function () {
    ...
    option = {
        ...
        color: ["rgb(115, 93, 255)", "rgb(255, 90, 41)", "rgb(12, 199, 99)", "rgb(12, 156, 252)", "rgb(255, 154, 19)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: ["rgb(115, 93, 255)", "rgb(255, 90, 41)", "rgb(12, 199, 99)", "rgb(12, 156, 252)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: [     "rgb(115, 93, 255)", "rgb(255, 90, 41)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        color: [     "rgb(115, 93, 255)", "rgb(255, 90, 41)", "rgb(12, 199, 99)", "rgb(12, 156, 252)","rgba(255,154,19)"]
    };
    if (option && typeof option === 'object') {
        myChart.setOption(option);
    }
    ...
    option = {
        ...
        series: [
            ...
            },
            {
                ...
                itemStyle: {
                    shadowBlur: 10,
                    shadowColor: 'rgb(115, 93, 255,0.3)',
                    shadowOffsetY: 5,
                    color: new echarts.graphic.RadialGradient(0.4, 0.3, 1, [
                        {
                            offset: 0,
        ...
        series: [
            {
                ...
                itemStyle: {
                    normal: {
                        color: "rgb(115, 93, 255)",
                        color0: "rgb(255, 90, 41)",
                        borderColor: "rgb(115, 93, 255)",
                        borderColor0: "rgb(255, 90, 41)",
                    }
                }
            }
        ]
