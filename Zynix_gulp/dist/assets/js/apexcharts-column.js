(function () {
    ...
    var options = {
        ...
        colors: ["#735dff", "#ff5a29", "rgb(12, 199, 99)", "rgb(255, 154, 19)"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    var colors = ['#735dff', '#ff5a29', 'rgb(12, 199, 99)', 'rgb(255, 154, 19)', 'rgb(12, 156, 252)', 'rgb(255, 56, 60)', '#7b76fe'];
    ...
    var options = {
        ...
        colors: ['#735dff', 'rgb(12, 199, 99)', 'rgb(255, 154, 19)', 'rgb(12, 156, 252)', 'rgb(255, 56, 60)','rgb(0, 216, 216)','rgb(254, 84, 155)','rgb(254, 124, 88)'],
        plotOptions: {
            bar: {
                columnWidth: '30%',
                distributed: true,
